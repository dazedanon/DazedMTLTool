...
## Game Translation Frame

# Dragondia - Translation Frame

世界観: A mature dark-fantasy JRPG set in the Kingdom of La Mer, following an exiled female knight through royal intrigue, guild quests, spirit mythology, demonic conflict, broad comedy, and explicit adult episodes.

時代感: Medieval European-inspired castles, knighthood, guilds, swords, armor, magic, alchemy, and ancient ruins, with occasional advanced relics and weapons that do not displace the traditional fantasy atmosphere.

文体方針: Use natural modern English for ordinary dialogue and concise functional English for UI text, with dignified courtly or mythic prose for royalty, religion, spirits, and ancient lore.

固有名詞方針: Use consistent Anglicized spellings for personal names; translate meaningful ranks, institutions, factions, and locations semantically while preserving recognizable myth-derived names.

神話・伝承: The setting combines original Dragon God and spirit mythology with a monotheistic religious schism and eclectic Biblical, Greek, Roman, Norse, and Latin-derived references.

## Game-Specific Translation Quirks

- Keep battle-log and system action messages in third person with explicit battler names; preserve placeholders such as %1 and avoid hard-coded gendered pronouns.
- Write item descriptions as compact factual statements that foreground their practical effect.
- Preserve equipment category labels, then describe construction or material in one concise sentence.
- Present upgraded weapon descriptions as a short physical description followed by a terse "Skill:" list.
- Begin bestiary descriptions with "Habitat: <location>" and continue in concise encyclopedic prose.
- Render quest notices and objectives as concise UI copy; preserve requester, location, difficulty, and reward labels and use imperative wording for objectives.
- Reserve archaic or elevated diction for ancient inscriptions, scripture, royalty, spirits, and mythic beings; keep ordinary NPC dialogue contemporary.
- Translate explicit sexual content directly and preserve whether a scene is comedic, consensual, threatening, or coercive without euphemistic sanitization.
