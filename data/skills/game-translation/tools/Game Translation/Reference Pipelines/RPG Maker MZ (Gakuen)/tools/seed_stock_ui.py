...
Every string below is unchanged RPG Maker MZ boilerplate that ships with the
...
BASIC = {0: "Level", 1: "Lv", 2: "HP", 3: "HP", 4: "MP", 5: "MP",
         6: "TP", 7: "TP", 8: "EXP", 9: "EXP"}
...
MESSAGES = {
    ...
    # The model rewrites this one to "but couldn't escape!" every time; the
    # canonical MZ string is the one below.
...
# The type lists below are RPG Maker MZ's own defaults everywhere the author
# left them alone, and a literal reading everywhere he did not:
#   equipTypes[1] is 杖 rather than the stock 武器 - this is a mage academy and
#   the weapon slot really is a wand, so "Wand" and not "Weapon".
#   equipTypes[5] and [6] are BOTH 装飾品; two accessory slots is deliberate and
#   both keep the same label, because the index is what distinguishes them.
OTHER = {
    "System:currencyUnit": "G",
    "System:armorTypes:1": "General Armor",
    "System:armorTypes:2": "Magic Armor",
    "System:armorTypes:3": "Light Armor",
    "System:armorTypes:4": "Heavy Armor",
    "System:armorTypes:5": "Small Shield",
    "System:armorTypes:6": "Large Shield",
    "System:weaponTypes:1": "Dagger",
    "System:weaponTypes:2": "Sword",
    "System:weaponTypes:3": "Flail",
    "System:weaponTypes:4": "Axe",
    "System:weaponTypes:5": "Whip",
    "System:weaponTypes:6": "Staff",
    "System:weaponTypes:7": "Bow",
    "System:weaponTypes:8": "Crossbow",
    "System:weaponTypes:9": "Gun",
    "System:weaponTypes:10": "Claw",
    "System:weaponTypes:11": "Glove",
    "System:weaponTypes:12": "Spear",
    "System:equipTypes:1": "Wand",
    "System:equipTypes:2": "Clothing",
    "System:equipTypes:3": "Underwear",
    "System:equipTypes:4": "Armor",
    "System:equipTypes:5": "Accessory",
    "System:equipTypes:6": "Accessory",
    "System:skillTypes:1": "Magic",
    "System:skillTypes:2": "Special",
    "System:skillTypes:3": "Condition",
    "System:elements:1": "Physical",
    "System:elements:2": "Fire",
    "System:elements:3": "Ice",
    "System:elements:4": "Thunder",
    "System:elements:5": "Water",
    "System:elements:6": "Earth",
    "System:elements:7": "Wind",
    "System:elements:8": "Light",
    "System:elements:9": "Darkness",
}
