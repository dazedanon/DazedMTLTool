...
def inpaint_pyramid(rgb, hole, levels=6, iters=120):
    """Coarse-to-fine fill: the only thing that works when the hole is huge.
    ...
    so at full resolution there is nothing local to propagate and every
    single-scale method fails: diffusion averages the backdrop across the skin,
