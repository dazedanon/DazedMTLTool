...
namespace Il2CppDumper
{
    ...
    // FORK: the 15-field "modern" Il2CppCodeRegistration WITHOUT the v29.1
    // unresolvedInstance/StaticCallPointers split. Some binaries report metadata v29.1+ (e.g. certain
    // v31 builds such as Blue Archive) yet ship this older code-registration layout. No Version
    // attributes here, so every field is read regardless of Version; used only as an auto-detected
    // fallback in Il2Cpp.Init when the normal parse's codeGenModules chain doesn't validate.
    public class Il2CppCodeRegistrationV27NoUnresolvedSplit
    {
        public ulong reversePInvokeWrapperCount;
        public ulong reversePInvokeWrappers;
        public ulong genericMethodPointersCount;
        ...
        public Il2CppCodeRegistration ToFull() => new Il2CppCodeRegistration
        {
            reversePInvokeWrapperCount = reversePInvokeWrapperCount,
