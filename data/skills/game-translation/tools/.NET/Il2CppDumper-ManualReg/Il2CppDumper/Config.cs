namespace Il2CppDumper
{
    public class Config
    {
        ...
        // Fork additions: bypass auto-search for protected binaries (WinLicense-stripped
        // CodeRegistration/MetadataRegistration). Provide the VAs found manually, run
        // against a flat in-memory dump (file offset == RVA) via ForceDumpImageBase.
        public bool ForceManualRegistration { get; set; } = false;
        public string ForceCodeRegistration { get; set; } = "0";
        public string ForceMetadataRegistration { get; set; } = "0";
        public string ForceDumpImageBase { get; set; } = "0";
    }
}
